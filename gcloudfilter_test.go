...
func TestParse(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: `{"terms":[{"key":"labels","attribute-key":"color","operator":"=","value":{"literal":"red"},"logical-operator":{"operator":"OR"}},{"key":"parent","attribute-key":"id","operator":":","value":{"floating-point-numeric-constant":25000000000},"logical-operator":{"operator":""}},{"key":"parent","attribute-key":"id","operator":":","value":{"integer":-56},"logical-operator":{"operator":"OR"}},{"key":"name","operator":":","value":{"literal":"^HOWL.*$"},"logical-operator":{"operator":"AND"}},{"key":"name","operator":":","value":{"literal":"^bOWL.*$"},"logical-operator":{"operator":""}}]}`,
		},
		{
